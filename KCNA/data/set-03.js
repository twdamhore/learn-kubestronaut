...
var questions = [
  ...
  },
  {
    ...
    diagram: '<svg viewBox="0 0 400 200" xmlns="http://www.w3.org/2000/svg"><rect x="30" y="10" width="100" height="35" rx="4" fill="#326CE5"/><text x="80" y="32" text-anchor="middle" fill="#fff" font-size="10">App Pod</text><rect x="30" y="80" width="100" height="35" rx="4" fill="#FF9800"/><text x="80" y="102" text-anchor="middle" fill="#fff" font-size="10">CoreDNS</text><rect x="30" y="150" width="100" height="35" rx="4" fill="#4CAF50"/><text x="80" y="172" text-anchor="middle" fill="#fff" font-size="10">Upstream DNS</text><line x1="80" y1="45" x2="80" y2="80" stroke="#999" stroke-width="1.5"/><line x1="80" y1="115" x2="80" y2="150" stroke="#999" stroke-width="1.5"/><text x="180" y="60" fill="#f44" font-size="10">A + AAAA sent</text><text x="180" y="75" fill="#f44" font-size="10">simultaneously</text><text x="180" y="105" fill="#ccc" font-size="9">??? root cause ???</text><text x="180" y="120" fill="#ccc" font-size="9">one query lost</text><text x="180" y="140" fill="#ccc" font-size="9">→ delay observed</text></svg>',
    options: [
