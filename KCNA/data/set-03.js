...
var questions = [
  ...
  },
  {
    ...
    text: "A team performs a canary deployment of a new version of their Service. They want 10% of traffic routed to the canary pods. The standard Kubernetes `Service` object load-balances equally across all endpoints. How can they achieve weighted routing?",
    diagram: null,
    options: [
  ...
  },
  {
    ...
    domain: "Kubernetes Fundamentals",
    subsection: "Cluster Architecture",
    text: "Which Kubernetes component watches for Service and Endpoint changes and updates the forwarding rules on each node?",
  ...
  },
  {
    ...
    diagram: '<svg viewBox="0 0 400 150" xmlns="http://www.w3.org/2000/svg"><rect x="130" y="50" width="140" height="50" rx="4" fill="#f44336"/><text x="200" y="72" text-anchor="middle" fill="#fff" font-size="11">app: web</text><text x="200" y="88" text-anchor="middle" fill="#fff" font-size="9">NetworkPolicy applied</text><line x1="50" y1="75" x2="130" y2="75" stroke="#f44" stroke-width="2"/><text x="90" y="65" text-anchor="middle" fill="#f44" font-size="16">X</text><text x="50" y="110" fill="#ccc" font-size="9">Ingress blocked</text><line x1="270" y1="75" x2="360" y2="75" stroke="#f44" stroke-width="2"/><text x="315" y="65" text-anchor="middle" fill="#f44" font-size="16">X</text><text x="330" y="110" fill="#ccc" font-size="9">Egress blocked</text><text x="200" y="140" text-anchor="middle" fill="#ff9800" font-size="10">policyTypes: [Ingress, Egress] — no rules defined</text></svg>',
    options: [
  ...
  },
  {
    ...
    diagram: '<svg viewBox="0 0 400 180" xmlns="http://www.w3.org/2000/svg"><rect x="10" y="70" width="100" height="40" rx="4" fill="#326CE5"/><text x="60" y="95" text-anchor="middle" fill="#fff" font-size="11">order-svc</text><rect x="150" y="70" width="100" height="40" rx="4" fill="#FF5722"/><text x="200" y="95" text-anchor="middle" fill="#fff" font-size="11">inventory-svc</text><text x="200" y="60" text-anchor="middle" fill="#f44" font-size="10">SLOW</text><line x1="110" y1="90" x2="150" y2="90" stroke="#999" stroke-width="2"/><rect x="280" y="25" width="110" height="30" rx="4" fill="#4CAF50"/><text x="335" y="45" text-anchor="middle" fill="#fff" font-size="10">Circuit Breaker</text><rect x="280" y="70" width="110" height="30" rx="4" fill="#FF9800"/><text x="335" y="90" text-anchor="middle" fill="#fff" font-size="10">Retry with Backoff</text><rect x="280" y="115" width="110" height="30" rx="4" fill="#9C27B0"/><text x="335" y="135" text-anchor="middle" fill="#fff" font-size="10">Timeout</text></svg>',
    options: [
  ...
  },
  {
    ...
    domain: "Cloud Native Architecture",
    subsection: "CNCF Ecosystem",
    text: "Which CNCF project provides a standards-based API for configuring advanced traffic routing in Kubernetes, designed as the successor to the Ingress API?",
    diagram: null,
    options: [
  ...
  },
  {
    ...
    diagram: '<svg viewBox="0 0 400 150" xmlns="http://www.w3.org/2000/svg"><rect x="100" y="10" width="200" height="30" rx="4" fill="#326CE5"/><text x="200" y="30" text-anchor="middle" fill="#fff" font-size="10">Headless Svc: mysubdomain</text><line x1="200" y1="40" x2="200" y2="65" stroke="#999" stroke-width="1.5"/><rect x="120" y="65" width="160" height="35" rx="4" fill="#4CAF50"/><text x="200" y="82" text-anchor="middle" fill="#fff" font-size="10">Pod: hostname=myhost</text><text x="200" y="95" text-anchor="middle" fill="#fff" font-size="8">subdomain=mysubdomain</text><text x="200" y="125" text-anchor="middle" fill="#ff9800" font-size="10">DNS: myhost.mysubdomain.&lt;ns&gt;.svc.cluster.local</text></svg>',
    options: [
  ...
  },
  {
    ...
    diagram: null,
    options: [
      "The Service must use TLS 1.2 for all connections between the proxy and the backend pods",
  ...
  },
  {
    ...
    diagram: '<svg viewBox="0 0 400 250" xmlns="http://www.w3.org/2000/svg"><text x="200" y="20" text-anchor="middle" fill="#fff" font-size="13" font-weight="bold">Zero-Trust Network</text><rect x="20" y="40" width="160" height="40" rx="4" fill="#326CE5"/><text x="100" y="65" text-anchor="middle" fill="#fff" font-size="10">NetworkPolicy (L3/L4)</text><rect x="220" y="40" width="160" height="40" rx="4" fill="#4CAF50"/><text x="300" y="65" text-anchor="middle" fill="#fff" font-size="10">mTLS (Service Mesh)</text><rect x="20" y="110" width="160" height="40" rx="4" fill="#FF9800"/><text x="100" y="135" text-anchor="middle" fill="#fff" font-size="10">Identity-based Auth</text><rect x="220" y="110" width="160" height="40" rx="4" fill="#9C27B0"/><text x="300" y="135" text-anchor="middle" fill="#fff" font-size="10">Encrypted Traffic</text><rect x="120" y="180" width="160" height="40" rx="4" fill="#f44336"/><text x="200" y="205" text-anchor="middle" fill="#fff" font-size="10">Default Deny All</text></svg>',
    options: [
