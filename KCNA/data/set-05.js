...
var questions = [
  ...
  },
  {
    ...
    diagram: '<svg viewBox="0 0 400 120" xmlns="http://www.w3.org/2000/svg"><rect x="10" y="40" width="80" height="40" rx="5" fill="#16213e" stroke="#4cc9f0" stroke-width="1.5"/><text x="50" y="65" text-anchor="middle" fill="#f8f8f2" font-size="10">kubectl</text><rect x="110" y="40" width="90" height="40" rx="5" fill="#16213e" stroke="#4cc9f0" stroke-width="1.5"/><text x="155" y="58" text-anchor="middle" fill="#f8f8f2" font-size="9">API Server</text><text x="155" y="72" text-anchor="middle" fill="#f8f8f2" font-size="9">AuthN/AuthZ</text><rect x="220" y="40" width="80" height="40" rx="5" fill="#16213e" stroke="#ff5555" stroke-width="2"/><text x="260" y="58" text-anchor="middle" fill="#ff5555" font-size="9">Admission</text><text x="260" y="72" text-anchor="middle" fill="#ff5555" font-size="9">(PSA)</text><rect x="320" y="40" width="70" height="40" rx="5" fill="#16213e" stroke="#6272a4" stroke-width="1.5" stroke-dasharray="4,3"/><text x="355" y="65" text-anchor="middle" fill="#6272a4" font-size="10">etcd</text><line x1="90" y1="60" x2="110" y2="60" stroke="#4cc9f0" stroke-width="1.5" marker-end="url(#a4)"/><line x1="200" y1="60" x2="220" y2="60" stroke="#4cc9f0" stroke-width="1.5" marker-end="url(#a4)"/><line x1="300" y1="60" x2="320" y2="60" stroke="#6272a4" stroke-width="1.5" stroke-dasharray="4,3"/><text x="260" y="100" text-anchor="middle" fill="#ff5555" font-size="10">REJECTED HERE</text><defs><marker id="a4" markerWidth="8" markerHeight="6" refX="8" refY="3" orient="auto"><polygon points="0 0,8 3,0 6" fill="#4cc9f0"/></marker></defs></svg>',
    options: [
  ...
  },
  {
    ...
    options: [
      ...
      "Open Policy Agent, which evaluates admission control policies",
      "cert-manager, which automates TLS certificate provisioning",
  ...
  },
  {
    ...
    diagram: '<svg viewBox="0 0 400 180" xmlns="http://www.w3.org/2000/svg"><text x="200" y="20" text-anchor="middle" fill="#4cc9f0" font-size="12">Capabilities Configuration</text><rect x="20" y="35" width="170" height="65" rx="6" fill="#1a1a2e" stroke="#ff5555" stroke-width="2"/><text x="105" y="55" text-anchor="middle" fill="#ff5555" font-size="11">drop: [ALL]</text><text x="105" y="75" text-anchor="middle" fill="#6272a4" font-size="9">CHOWN, DAC_OVERRIDE,</text><text x="105" y="88" text-anchor="middle" fill="#6272a4" font-size="9">FOWNER, KILL, ...</text><rect x="210" y="35" width="170" height="65" rx="6" fill="#1a1a2e" stroke="#50fa7b" stroke-width="2"/><text x="295" y="55" text-anchor="middle" fill="#50fa7b" font-size="11">add: [NET_BIND_SERVICE]</text><text x="295" y="80" text-anchor="middle" fill="#f8f8f2" font-size="10">Only cap remaining</text><rect x="100" y="120" width="200" height="45" rx="6" fill="#16213e" stroke="#f1fa8c" stroke-width="2"/><text x="200" y="140" text-anchor="middle" fill="#f1fa8c" font-size="11">Effective: NET_BIND_SERVICE</text><text x="200" y="155" text-anchor="middle" fill="#f8f8f2" font-size="9">minimal privilege</text><line x1="105" y1="100" x2="175" y2="120" stroke="#ff5555" stroke-width="1.5"/><line x1="295" y1="100" x2="225" y2="120" stroke="#50fa7b" stroke-width="1.5"/></svg>',
    options: [
  ...
  },
  {
    ...
    diagram: '<svg viewBox="0 0 400 180" xmlns="http://www.w3.org/2000/svg"><rect x="20" y="20" width="140" height="50" rx="6" fill="#16213e" stroke="#4cc9f0" stroke-width="2"/><text x="90" y="50" text-anchor="middle" fill="#f8f8f2" font-size="12">ClusterRole</text><rect x="240" y="20" width="140" height="50" rx="6" fill="#16213e" stroke="#f72585" stroke-width="2"/><text x="310" y="50" text-anchor="middle" fill="#f8f8f2" font-size="12">ClusterRoleBinding</text><rect x="130" y="120" width="140" height="50" rx="6" fill="#16213e" stroke="#7b2ff7" stroke-width="2"/><text x="200" y="150" text-anchor="middle" fill="#f8f8f2" font-size="12">ServiceAccount</text><line x1="160" y1="45" x2="240" y2="45" stroke="#4cc9f0" stroke-width="1.5" stroke-dasharray="5,3"/><text x="200" y="38" text-anchor="middle" fill="#b5179e" font-size="9">references</text><line x1="310" y1="70" x2="200" y2="120" stroke="#f72585" stroke-width="1.5" stroke-dasharray="5,3"/><text x="270" y="100" text-anchor="middle" fill="#b5179e" font-size="9">binds to</text></svg>',
    options: [
  ...
  },
  {
    ...
    options: [
      ...
      "`privileged: false` — disables privileged mode but does not block setuid escalation",
  ...
  },
  {
    ...
    diagram: '<svg viewBox="0 0 400 220" xmlns="http://www.w3.org/2000/svg"><rect x="10" y="20" width="180" height="90" rx="8" fill="#1a1a2e" stroke="#4cc9f0" stroke-width="2"/><text x="100" y="14" text-anchor="middle" fill="#4cc9f0" font-size="11">ns: database</text><rect x="30" y="45" width="140" height="35" rx="5" fill="#16213e" stroke="#f72585" stroke-width="1.5"/><text x="100" y="67" text-anchor="middle" fill="#f8f8f2" font-size="10">role: db (target)</text><rect x="10" y="130" width="180" height="80" rx="8" fill="#1a1a2e" stroke="#4cc9f0" stroke-width="2"/><text x="100" y="125" text-anchor="middle" fill="#4cc9f0" font-size="11">ns: database</text><rect x="30" y="150" width="140" height="35" rx="5" fill="#16213e" stroke="#50fa7b" stroke-width="1.5"/><text x="100" y="172" text-anchor="middle" fill="#f8f8f2" font-size="10">role: backend</text><rect x="220" y="130" width="170" height="80" rx="8" fill="#1a1a2e" stroke="#4cc9f0" stroke-width="2"/><text x="305" y="125" text-anchor="middle" fill="#4cc9f0" font-size="11">ns: other</text><rect x="240" y="150" width="130" height="35" rx="5" fill="#16213e" stroke="#ff5555" stroke-width="1.5"/><text x="305" y="172" text-anchor="middle" fill="#f8f8f2" font-size="10">role: backend</text><line x1="100" y1="150" x2="100" y2="80" stroke="#50fa7b" stroke-width="2" marker-end="url(#arr2)"/><line x1="305" y1="150" x2="130" y2="80" stroke="#ff5555" stroke-width="2" stroke-dasharray="6,3" marker-end="url(#arr3)"/><text x="260" y="108" fill="#ff5555" font-size="9">DENIED</text><text x="70" y="118" fill="#50fa7b" font-size="9">ALLOWED</text><defs><marker id="arr2" markerWidth="8" markerHeight="6" refX="8" refY="3" orient="auto"><polygon points="0 0,8 3,0 6" fill="#50fa7b"/></marker><marker id="arr3" markerWidth="8" markerHeight="6" refX="8" refY="3" orient="auto"><polygon points="0 0,8 3,0 6" fill="#ff5555"/></marker></defs></svg>',
    options: [
  ...
  },
  {
    ...
    diagram: '<svg viewBox="0 0 400 200" xmlns="http://www.w3.org/2000/svg"><rect x="30" y="10" width="340" height="180" rx="10" fill="#1a1a2e" stroke="#4cc9f0" stroke-width="2"/><text x="200" y="35" text-anchor="middle" fill="#4cc9f0" font-size="12">Pod securityContext</text><text x="200" y="55" text-anchor="middle" fill="#f8f8f2" font-size="11">runAsUser: 1000</text><rect x="50" y="75" width="130" height="100" rx="6" fill="#16213e" stroke="#50fa7b" stroke-width="1.5"/><text x="115" y="100" text-anchor="middle" fill="#50fa7b" font-size="11">Container A</text><text x="115" y="120" text-anchor="middle" fill="#f8f8f2" font-size="10">runAsUser: 2000</text><text x="115" y="155" text-anchor="middle" fill="#f1fa8c" font-size="11">UID = 2000</text><rect x="220" y="75" width="130" height="100" rx="6" fill="#16213e" stroke="#ff79c6" stroke-width="1.5"/><text x="285" y="100" text-anchor="middle" fill="#ff79c6" font-size="11">Container B</text><text x="285" y="120" text-anchor="middle" fill="#f8f8f2" font-size="10">(no override)</text><text x="285" y="155" text-anchor="middle" fill="#f1fa8c" font-size="11">UID = 1000</text></svg>',
    options: [
  ...
  },
  {
    ...
    diagram: '<svg viewBox="0 0 400 200" xmlns="http://www.w3.org/2000/svg"><rect x="20" y="20" width="120" height="50" rx="6" fill="#16213e" stroke="#ff5555" stroke-width="2"/><text x="80" y="50" text-anchor="middle" fill="#f8f8f2" font-size="11">Attacker</text><rect x="260" y="20" width="120" height="50" rx="6" fill="#16213e" stroke="#4cc9f0" stroke-width="2"/><text x="320" y="50" text-anchor="middle" fill="#f8f8f2" font-size="11">API Server</text><rect x="140" y="130" width="120" height="50" rx="6" fill="#16213e" stroke="#f1fa8c" stroke-width="2"/><text x="200" y="160" text-anchor="middle" fill="#f8f8f2" font-size="11">cluster-admin</text><line x1="140" y1="45" x2="260" y2="45" stroke="#ff5555" stroke-width="2" marker-end="url(#arr4)"/><text x="200" y="38" text-anchor="middle" fill="#ff5555" font-size="9">impersonate</text><line x1="80" y1="70" x2="200" y2="130" stroke="#f1fa8c" stroke-width="1.5" stroke-dasharray="5,3"/><text x="120" y="108" fill="#f1fa8c" font-size="9">acts as</text><defs><marker id="arr4" markerWidth="8" markerHeight="6" refX="8" refY="3" orient="auto"><polygon points="0 0,8 3,0 6" fill="#ff5555"/></marker></defs></svg>',
    options: [
  ...
  },
  {
    ...
    diagram: '<svg viewBox="0 0 400 200" xmlns="http://www.w3.org/2000/svg"><text x="200" y="18" text-anchor="middle" fill="#4cc9f0" font-size="12">Secret Exposure Risk</text><rect x="15" y="30" width="175" height="160" rx="8" fill="#1a1a2e" stroke="#ff5555" stroke-width="2"/><text x="102" y="50" text-anchor="middle" fill="#ff5555" font-size="11">Env Vars (risky)</text><text x="102" y="72" fill="#f8f8f2" font-size="9" text-anchor="middle">/proc/pid/environ</text><text x="102" y="90" fill="#f8f8f2" font-size="9" text-anchor="middle">crash dumps</text><text x="102" y="108" fill="#f8f8f2" font-size="9" text-anchor="middle">docker inspect</text><text x="102" y="126" fill="#f8f8f2" font-size="9" text-anchor="middle">app framework logs</text><text x="102" y="148" fill="#ff5555" font-size="9" text-anchor="middle">child process inherit</text><text x="102" y="175" fill="#ff5555" font-size="11" text-anchor="middle">MULTIPLE VECTORS</text><rect x="210" y="30" width="175" height="160" rx="8" fill="#1a1a2e" stroke="#50fa7b" stroke-width="2"/><text x="297" y="50" text-anchor="middle" fill="#50fa7b" font-size="11">Volume Mount (safer)</text><text x="297" y="72" fill="#f8f8f2" font-size="9" text-anchor="middle">tmpfs / file perms</text><text x="297" y="90" fill="#f8f8f2" font-size="9" text-anchor="middle">not in env listing</text><text x="297" y="108" fill="#f8f8f2" font-size="9" text-anchor="middle">not in crash dumps</text><text x="297" y="126" fill="#f8f8f2" font-size="9" text-anchor="middle">auto-rotated by kubelet</text><text x="297" y="175" fill="#50fa7b" font-size="11" text-anchor="middle">REDUCED SURFACE</text></svg>',
    options: [
  ...
  },
  {
    ...
    diagram: '<svg viewBox="0 0 400 180" xmlns="http://www.w3.org/2000/svg"><rect x="20" y="30" width="100" height="45" rx="6" fill="#16213e" stroke="#4cc9f0" stroke-width="2"/><text x="70" y="57" text-anchor="middle" fill="#f8f8f2" font-size="11">Pod (no RC)</text><rect x="160" y="30" width="100" height="45" rx="6" fill="#16213e" stroke="#f1fa8c" stroke-width="2"/><text x="210" y="57" text-anchor="middle" fill="#f8f8f2" font-size="11">Webhook</text><rect x="300" y="30" width="90" height="45" rx="6" fill="#16213e" stroke="#ff5555" stroke-width="2"/><text x="345" y="57" text-anchor="middle" fill="#ff5555" font-size="11">REJECTED</text><line x1="120" y1="52" x2="160" y2="52" stroke="#4cc9f0" stroke-width="1.5" marker-end="url(#arr5)"/><line x1="260" y1="52" x2="300" y2="52" stroke="#ff5555" stroke-width="1.5" marker-end="url(#arr6)"/><text x="210" y="100" text-anchor="middle" fill="#f8f8f2" font-size="10">runtimeClassName required</text><defs><marker id="arr5" markerWidth="8" markerHeight="6" refX="8" refY="3" orient="auto"><polygon points="0 0,8 3,0 6" fill="#4cc9f0"/></marker><marker id="arr6" markerWidth="8" markerHeight="6" refX="8" refY="3" orient="auto"><polygon points="0 0,8 3,0 6" fill="#ff5555"/></marker></defs></svg>',
    options: [
  ...
  },
  {
    ...
    domain: "Cloud Native Application Delivery",
    subsection: "CI/CD",
    text: "A CI/CD pipeline runs `kubectl apply` using a ServiceAccount bound to a custom ClusterRole. The ClusterRole grants `create`, `update`, and `delete` on Deployments, Services, and ConfigMaps. A developer modifies the pipeline to also deploy a ClusterRoleBinding granting `cluster-admin`. What happens?",
    diagram: null,
    options: [
