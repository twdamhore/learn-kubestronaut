...
var questions = [
  ...
  },
  {
    ...
    diagram: '<svg viewBox="0 0 400 250" xmlns="http://www.w3.org/2000/svg"><rect x="140" y="5" width="120" height="35" rx="6" fill="#326CE5" stroke="#fff" stroke-width="1.5"/><text x="200" y="28" text-anchor="middle" fill="white" font-size="11">API Server</text><rect x="10" y="100" width="110" height="35" rx="6" fill="#555" stroke="#aaa" stroke-width="1"/><text x="65" y="122" text-anchor="middle" fill="white" font-size="10">Controller Mgr</text><rect x="145" y="100" width="110" height="35" rx="6" fill="#4CAF50" stroke="#fff" stroke-width="1"/><text x="200" y="122" text-anchor="middle" fill="white" font-size="10">Scheduler</text><rect x="280" y="100" width="110" height="35" rx="6" fill="#FF9800" stroke="#fff" stroke-width="1"/><text x="335" y="122" text-anchor="middle" fill="white" font-size="10">etcd</text><rect x="140" y="195" width="120" height="35" rx="6" fill="#0db7ed" stroke="#fff" stroke-width="1"/><text x="200" y="217" text-anchor="middle" fill="white" font-size="11">Kubelet</text><line x1="200" y1="40" x2="65" y2="100" stroke="#aaa" stroke-width="1.5"/><line x1="200" y1="40" x2="200" y2="100" stroke="#aaa" stroke-width="1.5"/><line x1="200" y1="40" x2="335" y2="100" stroke="#aaa" stroke-width="1.5"/><line x1="200" y1="135" x2="200" y2="195" stroke="#aaa" stroke-width="1.5"/><text x="200" y="175" text-anchor="middle" fill="#ccc" font-size="12">? What is the correct order ?</text></svg>',
    options: [
