...
var questions = [
  ...
  },
  {
    ...
    diagram: "<svg viewBox='0 0 400 200' xmlns='http://www.w3.org/2000/svg'><rect x='10' y='10' width='180' height='75' rx='6' fill='#1a1a2e' stroke='#326CE5' stroke-width='1.5'/><text x='100' y='30' text-anchor='middle' fill='#326CE5' font-size='10'>ResourceQuota</text><text x='100' y='48' text-anchor='middle' fill='#aaa' font-size='9'>requests.cpu: 2 (used: 1500m)</text><text x='100' y='63' text-anchor='middle' fill='#aaa' font-size='9'>limits.cpu: 4 (used: 3000m)</text><text x='100' y='78' text-anchor='middle' fill='#FF9800' font-size='8'>Remaining: 500m req / 1000m lim</text><rect x='210' y='10' width='180' height='55' rx='6' fill='#1a1a2e' stroke='#4CAF50' stroke-width='1.5'/><text x='300' y='30' text-anchor='middle' fill='#4CAF50' font-size='10'>LimitRange Defaults</text><text x='300' y='48' text-anchor='middle' fill='#aaa' font-size='9'>req: 250m / lim: 500m per pod</text><rect x='10' y='110' width='55' height='35' rx='4' fill='#4CAF50' stroke='#fff'/><text x='37' y='132' text-anchor='middle' fill='#fff' font-size='8'>New Pod 1</text><rect x='75' y='110' width='55' height='35' rx='4' fill='#4CAF50' stroke='#fff'/><text x='102' y='132' text-anchor='middle' fill='#fff' font-size='8'>New Pod 2</text><rect x='140' y='110' width='55' height='35' rx='4' fill='#f44336' stroke='#fff'/><text x='167' y='132' text-anchor='middle' fill='#fff' font-size='8'>Pod 3</text><text x='167' y='158' text-anchor='middle' fill='#f44' font-size='8'>BLOCKED</text><text x='300' y='130' text-anchor='middle' fill='#aaa' font-size='9'>+250m req each = exceeds quota</text><text x='300' y='145' text-anchor='middle' fill='#aaa' font-size='9'>at 3rd pod (2250m > 2000m)</text></svg>",
    options: [
  ...
  },
  {
    ...
    diagram: null,
    options: [
      "A. The scheduler preempts the lowest-priority pod(s) until enough resources are freed for the new pod, respecting PodDisruptionBudgets",
    ...
    answer: 0,
    explanation: "When a pod cannot be scheduled on any node, the scheduler evaluates preemption. It identifies the lowest-priority pods on candidate nodes that, if removed, would free sufficient resources for the new high-priority pod. The scheduler respects `PodDisruptionBudgets` (PDBs) during preemption — it will not preempt pods if doing so would violate a PDB, unless no alternative exists. In this scenario, the scheduler would preempt enough low-priority pods to free at least 3 CPU and 6Gi, as long as PDBs allow it.",
  ...
  },
  {
    ...
    diagram: "<svg viewBox='0 0 400 250' xmlns='http://www.w3.org/2000/svg'><rect x='140' y='5' width='120' height='30' rx='5' fill='#FF9800' stroke='#fff'/><text x='200' y='25' text-anchor='middle' fill='#fff' font-size='11'>Load Balancer</text><rect x='20' y='80' width='70' height='40' rx='5' fill='#4CAF50' stroke='#fff'/><text x='55' y='97' text-anchor='middle' fill='#fff' font-size='9'>Node 1</text><text x='55' y='112' text-anchor='middle' fill='#fff' font-size='8'>Pod A</text><rect x='110' y='80' width='70' height='40' rx='5' fill='#4CAF50' stroke='#fff'/><text x='145' y='97' text-anchor='middle' fill='#fff' font-size='9'>Node 2</text><text x='145' y='112' text-anchor='middle' fill='#fff' font-size='8'>Pod B</text><rect x='220' y='80' width='70' height='40' rx='5' fill='#f44336' stroke='#fff'/><text x='255' y='97' text-anchor='middle' fill='#fff' font-size='9'>Node 3</text><text x='255' y='112' text-anchor='middle' fill='#fff' font-size='8'>No Pod</text><rect x='310' y='80' width='70' height='40' rx='5' fill='#f44336' stroke='#fff'/><text x='345' y='97' text-anchor='middle' fill='#fff' font-size='9'>Node 4</text><text x='345' y='112' text-anchor='middle' fill='#fff' font-size='8'>No Pod</text><line x1='200' y1='35' x2='55' y2='75' stroke='#4CAF50' stroke-width='1.5'/><line x1='200' y1='35' x2='145' y2='75' stroke='#4CAF50' stroke-width='1.5'/><line x1='200' y1='35' x2='255' y2='75' stroke='#f44' stroke-width='1.5' stroke-dasharray='4'/><line x1='200' y1='35' x2='345' y2='75' stroke='#f44' stroke-width='1.5' stroke-dasharray='4'/><text x='200' y='155' text-anchor='middle' fill='#aaa' font-size='10'>Health checks fail on Node 3 &amp; 4</text><text x='200' y='170' text-anchor='middle' fill='#aaa' font-size='10'>LB sends traffic only to Node 1 &amp; 2</text></svg>",
    options: [
  ...
  },
  {
    ...
    diagram: "<svg viewBox='0 0 400 200' xmlns='http://www.w3.org/2000/svg'><rect x='30' y='20' width='100' height='70' rx='6' fill='#326CE5' stroke='#fff' stroke-width='1.5'/><text x='80' y='42' text-anchor='middle' fill='#fff' font-size='9'>Control Plane 1</text><text x='80' y='57' text-anchor='middle' fill='#4CAF50' font-size='8'>CM: Leader</text><text x='80' y='72' text-anchor='middle' fill='#4CAF50' font-size='8'>Sched: Leader</text><rect x='150' y='20' width='100' height='70' rx='6' fill='#326CE5' stroke='#fff' stroke-width='1.5'/><text x='200' y='42' text-anchor='middle' fill='#fff' font-size='9'>Control Plane 2</text><text x='200' y='57' text-anchor='middle' fill='#aaa' font-size='8'>CM: Standby</text><text x='200' y='72' text-anchor='middle' fill='#aaa' font-size='8'>Sched: Standby</text><rect x='270' y='20' width='100' height='70' rx='6' fill='#326CE5' stroke='#fff' stroke-width='1.5'/><text x='320' y='42' text-anchor='middle' fill='#fff' font-size='9'>Control Plane 3</text><text x='320' y='57' text-anchor='middle' fill='#aaa' font-size='8'>CM: Standby</text><text x='320' y='72' text-anchor='middle' fill='#aaa' font-size='8'>Sched: Standby</text><rect x='100' y='120' width='200' height='40' rx='6' fill='#1a1a2e' stroke='#FF9800' stroke-width='1.5'/><text x='200' y='137' text-anchor='middle' fill='#FF9800' font-size='10'>Lease Objects in kube-system</text><text x='200' y='152' text-anchor='middle' fill='#FF9800' font-size='9'>Leader election via API</text><line x1='80' y1='90' x2='180' y2='118' stroke='#4CAF50' stroke-width='1.5'/><line x1='200' y1='90' x2='200' y2='118' stroke='#aaa' stroke-width='1' stroke-dasharray='4'/><line x1='320' y1='90' x2='220' y2='118' stroke='#aaa' stroke-width='1' stroke-dasharray='4'/></svg>",
    options: [
