...
var questions = [
  ...
  },
  {
    ...
    diagram: '<svg viewBox="0 0 400 200" xmlns="http://www.w3.org/2000/svg"><rect x="10" y="10" width="380" height="180" rx="8" fill="#1a1a2e" stroke="#444" stroke-width="1"/><text x="200" y="35" text-anchor="middle" fill="#7ec8e3" font-size="13" font-weight="bold">Scheduling Constraint</text><rect x="50" y="55" width="130" height="60" rx="6" fill="#0d2137" stroke="#326ce5" stroke-width="1.5"/><text x="115" y="82" text-anchor="middle" fill="#ccc" font-size="11">web-frontend</text><text x="115" y="100" text-anchor="middle" fill="#888" font-size="9">app=frontend</text><rect x="220" y="55" width="130" height="60" rx="6" fill="#0d2137" stroke="#326ce5" stroke-width="1.5"/><text x="285" y="82" text-anchor="middle" fill="#ccc" font-size="11">cache-service</text><text x="285" y="100" text-anchor="middle" fill="#888" font-size="9">app=cache</text><line x1="180" y1="85" x2="220" y2="85" stroke="#4caf50" stroke-width="2" stroke-dasharray="5,3"/><text x="200" y="78" text-anchor="middle" fill="#4caf50" font-size="9">co-locate?</text><rect x="30" y="130" width="340" height="40" rx="6" fill="#0d2137" stroke="#555" stroke-width="1"/><text x="200" y="155" text-anchor="middle" fill="#aaa" font-size="11">Node (Co-located on ?)</text></svg>',
    options: [
