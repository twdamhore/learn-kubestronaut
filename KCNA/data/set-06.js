...
var questions = [
  ...
  },
  {
    ...
    diagram: '<svg viewBox="0 0 400 200" xmlns="http://www.w3.org/2000/svg"><rect x="10" y="10" width="380" height="180" rx="8" fill="#1a1a2e" stroke="#444" stroke-width="1"/><text x="200" y="35" text-anchor="middle" fill="#7ec8e3" font-size="13" font-weight="bold">Scheduling Constraint</text><rect x="50" y="55" width="130" height="60" rx="6" fill="#0d2137" stroke="#326ce5" stroke-width="1.5"/><text x="115" y="82" text-anchor="middle" fill="#ccc" font-size="11">web-frontend</text><text x="115" y="100" text-anchor="middle" fill="#888" font-size="9">app=frontend</text><rect x="220" y="55" width="130" height="60" rx="6" fill="#0d2137" stroke="#326ce5" stroke-width="1.5"/><text x="285" y="82" text-anchor="middle" fill="#ccc" font-size="11">cache-service</text><text x="285" y="100" text-anchor="middle" fill="#888" font-size="9">app=cache</text><line x1="180" y1="85" x2="220" y2="85" stroke="#4caf50" stroke-width="2" stroke-dasharray="5,3"/><text x="200" y="78" text-anchor="middle" fill="#4caf50" font-size="9">co-locate?</text><rect x="30" y="130" width="340" height="40" rx="6" fill="#0d2137" stroke="#555" stroke-width="1"/><text x="200" y="155" text-anchor="middle" fill="#aaa" font-size="11">Node (topologyKey: kubernetes.io/hostname)</text></svg>',
    options: [
  ...
  },
  {
    ...
    diagram: '<svg viewBox="0 0 400 200" xmlns="http://www.w3.org/2000/svg"><rect x="5" y="5" width="390" height="190" rx="8" fill="#1a1a2e" stroke="#444" stroke-width="1"/><text x="200" y="28" text-anchor="middle" fill="#7ec8e3" font-size="13" font-weight="bold">Toleration Configuration</text><rect x="30" y="50" width="100" height="50" rx="5" fill="#0d2137" stroke="#ff9800" stroke-width="1.5"/><text x="80" y="72" text-anchor="middle" fill="#ff9800" font-size="9">Taint: gpu=true</text><text x="80" y="88" text-anchor="middle" fill="#888" font-size="8">NoSchedule</text><rect x="150" y="50" width="100" height="50" rx="5" fill="#0d2137" stroke="#ff9800" stroke-width="1.5"/><text x="200" y="72" text-anchor="middle" fill="#ff9800" font-size="9">Taint: team=ops</text><text x="200" y="88" text-anchor="middle" fill="#888" font-size="8">NoExecute</text><rect x="270" y="50" width="100" height="50" rx="5" fill="#0d2137" stroke="#ff9800" stroke-width="1.5"/><text x="320" y="72" text-anchor="middle" fill="#ff9800" font-size="9">Taint: any=any</text><text x="320" y="88" text-anchor="middle" fill="#888" font-size="8">PreferNoSchedule</text><rect x="100" y="125" width="200" height="40" rx="6" fill="#1a2a1a" stroke="#4caf50" stroke-width="1.5"/><text x="200" y="149" text-anchor="middle" fill="#4caf50" font-size="11">Which taints are matched?</text><line x1="80" y1="100" x2="200" y2="125" stroke="#4caf50" stroke-width="1" stroke-dasharray="3,3"/><line x1="200" y1="100" x2="200" y2="125" stroke="#4caf50" stroke-width="1" stroke-dasharray="3,3"/><line x1="320" y1="100" x2="200" y2="125" stroke="#4caf50" stroke-width="1" stroke-dasharray="3,3"/><text x="200" y="185" text-anchor="middle" fill="#888" font-size="9">???</text></svg>',
    options: [
