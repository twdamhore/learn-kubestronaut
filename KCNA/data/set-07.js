...
var questions = [
  ...
  },
  {
    ...
    diagram: '<svg viewBox="0 0 400 180" xmlns="http://www.w3.org/2000/svg"><rect x="10" y="10" width="380" height="160" rx="8" fill="#1a1a2e" stroke="#444" stroke-width="1.5"/><text x="200" y="35" text-anchor="middle" fill="#e0e0e0" font-size="13" font-weight="bold">Container Memory Lifecycle</text><rect x="30" y="55" width="90" height="40" rx="6" fill="#264653" stroke="#2a9d8f" stroke-width="1.5"/><text x="75" y="79" text-anchor="middle" fill="#e0e0e0" font-size="11">Running</text><line x1="120" y1="75" x2="155" y2="75" stroke="#888" stroke-width="1.5" marker-end="url(#arrow4)"/><rect x="155" y="55" width="100" height="40" rx="6" fill="#6b2c3b" stroke="#e76f51" stroke-width="1.5"/><text x="205" y="72" text-anchor="middle" fill="#e0e0e0" font-size="10">Memory exceeds</text><text x="205" y="85" text-anchor="middle" fill="#e0e0e0" font-size="10">limit</text><line x1="255" y1="75" x2="280" y2="75" stroke="#888" stroke-width="1.5" marker-end="url(#arrow4)"/><rect x="280" y="55" width="90" height="40" rx="6" fill="#7b2d26" stroke="#e63946" stroke-width="1.5"/><text x="325" y="72" text-anchor="middle" fill="#e0e0e0" font-size="10">OOMKilled</text><text x="325" y="85" text-anchor="middle" fill="#e0e0e0" font-size="10">Exit Code 137</text><text x="200" y="130" text-anchor="middle" fill="#aaa" font-size="10">Linux kernel sends SIGKILL (signal 9) when cgroup memory limit exceeded</text><text x="200" y="150" text-anchor="middle" fill="#aaa" font-size="10">Exit code = 128 + 9 = 137</text><defs><marker id="arrow4" viewBox="0 0 10 10" refX="9" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse"><path d="M 0 0 L 10 5 L 0 10 z" fill="#888"/></marker></defs></svg>',
    options: [
  ...
  },
  {
    ...
    diagram: null,
    options: [
      "`kubectl get pods -A --sort-by='.status.containerStatuses[0].restartCount'` for a one-time sorted list",
      "`kubectl get pods -A --watch` which continuously streams pod status updates as they occur in real time",
      "`kubectl top pods --all-namespaces` which shows CPU and memory usage but does not track restart counts",
  ...
  },
  {
    ...
    diagram: '<svg viewBox="0 0 400 200" xmlns="http://www.w3.org/2000/svg"><rect x="10" y="10" width="380" height="180" rx="8" fill="#1a1a2e" stroke="#444" stroke-width="1.5"/><text x="200" y="35" text-anchor="middle" fill="#e0e0e0" font-size="13" font-weight="bold">Startup Probe Timeline</text><line x1="40" y1="80" x2="370" y2="80" stroke="#555" stroke-width="2"/><rect x="40" y="65" width="200" height="30" rx="4" fill="#6b2c3b" stroke="#e76f51" stroke-width="1.5"/><text x="140" y="84" text-anchor="middle" fill="#e0e0e0" font-size="10">Startup Probe Active (0-300s)</text><rect x="240" y="65" width="60" height="30" rx="4" fill="#264653" stroke="#2a9d8f" stroke-width="1.5"/><text x="270" y="84" text-anchor="middle" fill="#e0e0e0" font-size="9">Liveness</text><rect x="305" y="65" width="60" height="30" rx="4" fill="#264653" stroke="#2a9d8f" stroke-width="1.5"/><text x="335" y="84" text-anchor="middle" fill="#e0e0e0" font-size="9">Readiness</text><text x="40" y="120" fill="#aaa" font-size="10">failureThreshold: 30</text><text x="40" y="138" fill="#aaa" font-size="10">periodSeconds: 10</text><text x="40" y="156" fill="#aaa" font-size="10">Max startup time: 30 x 10 = 300s</text><text x="40" y="174" fill="#e76f51" font-size="10">Liveness + Readiness disabled until startup succeeds</text></svg>',
    options: [
  ...
  },
  {
    ...
    diagram: null,
    options: [
      "`kube_pod_status_phase` filtered to `Failed` which only shows terminal pod states and not gradual memory trends",
      "`container_memory_working_set_bytes` tracked over time, showing continuous upward trend approaching the limit",
      "`node_memory_MemAvailable_bytes` to monitor overall node memory which lacks per-container granularity for leaks",
  ...
  },
  {
    ...
    diagram: null,
    options: [
      "It prevents the CronJob from running entirely if any other Job in the namespace is currently active",
  ...
  },
  {
    ...
    options: [
      ...
      "The TCP check is skipped entirely until the container's liveness probe passes its first successful health check",
  ...
  },
  {
    ...
    diagram: '<svg viewBox="0 0 400 200" xmlns="http://www.w3.org/2000/svg"><rect x="10" y="10" width="380" height="180" rx="8" fill="#1a1a2e" stroke="#444" stroke-width="1.5"/><text x="200" y="35" text-anchor="middle" fill="#e0e0e0" font-size="13" font-weight="bold">Kubelet Eviction Flow</text><rect x="30" y="55" width="110" height="35" rx="5" fill="#264653" stroke="#2a9d8f" stroke-width="1.5"/><text x="85" y="77" text-anchor="middle" fill="#e0e0e0" font-size="10">Node Memory</text><line x1="140" y1="72" x2="165" y2="72" stroke="#888" stroke-width="1.5" marker-end="url(#a68)"/><rect x="165" y="55" width="110" height="35" rx="5" fill="#6b2c3b" stroke="#e76f51" stroke-width="1.5"/><text x="220" y="70" text-anchor="middle" fill="#e0e0e0" font-size="9">Below threshold</text><text x="220" y="83" text-anchor="middle" fill="#e0e0e0" font-size="9">(eviction signal)</text><line x1="275" y1="72" x2="295" y2="72" stroke="#888" stroke-width="1.5" marker-end="url(#a68)"/><rect x="295" y="55" width="80" height="35" rx="5" fill="#7b2d26" stroke="#e63946" stroke-width="1.5"/><text x="335" y="77" text-anchor="middle" fill="#e0e0e0" font-size="10">Evict Pod</text><text x="200" y="120" text-anchor="middle" fill="#aaa" font-size="10">Eviction order: BestEffort > Burstable > Guaranteed</text><text x="200" y="140" text-anchor="middle" fill="#aaa" font-size="10">Pods using most resources relative to requests are evicted first</text><text x="200" y="165" text-anchor="middle" fill="#e76f51" font-size="10">Unlike OOMKill, eviction is a kubelet-level decision</text><defs><marker id="a68" viewBox="0 0 10 10" refX="9" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse"><path d="M 0 0 L 10 5 L 0 10 z" fill="#888"/></marker></defs></svg>',
    options: [
  ...
  },
  {
    ...
    diagram: '<svg viewBox="0 0 400 200" xmlns="http://www.w3.org/2000/svg"><rect x="10" y="10" width="380" height="180" rx="8" fill="#1a1a2e" stroke="#444" stroke-width="1.5"/><text x="200" y="35" text-anchor="middle" fill="#e0e0e0" font-size="13" font-weight="bold">Rolling Update: maxUnavailable=0, maxSurge=1</text><rect x="30" y="55" width="70" height="30" rx="5" fill="#264653" stroke="#2a9d8f" stroke-width="1.5"/><text x="65" y="74" text-anchor="middle" fill="#e0e0e0" font-size="9">old-1 OK</text><rect x="110" y="55" width="70" height="30" rx="5" fill="#264653" stroke="#2a9d8f" stroke-width="1.5"/><text x="145" y="74" text-anchor="middle" fill="#e0e0e0" font-size="9">old-2 OK</text><rect x="190" y="55" width="70" height="30" rx="5" fill="#264653" stroke="#2a9d8f" stroke-width="1.5"/><text x="225" y="74" text-anchor="middle" fill="#e0e0e0" font-size="9">old-3 OK</text><rect x="280" y="55" width="90" height="30" rx="5" fill="#7b2d26" stroke="#e63946" stroke-width="1.5"/><text x="325" y="74" text-anchor="middle" fill="#e0e0e0" font-size="9">new-1 CRASH</text><text x="200" y="120" text-anchor="middle" fill="#e76f51" font-size="11">Rollout stalled: new pod never Ready</text><text x="200" y="140" text-anchor="middle" fill="#aaa" font-size="10">Old pods preserved (maxUnavailable=0)</text><text x="200" y="160" text-anchor="middle" fill="#aaa" font-size="10">No downtime, but no progress either</text></svg>',
    options: [
  ...
  },
  {
    ...
    diagram: '<svg viewBox="0 0 400 180" xmlns="http://www.w3.org/2000/svg"><rect x="10" y="10" width="380" height="160" rx="8" fill="#1a1a2e" stroke="#444" stroke-width="1.5"/><text x="200" y="35" text-anchor="middle" fill="#e0e0e0" font-size="13" font-weight="bold">Exec Liveness Probe Flow</text><rect x="25" y="55" width="85" height="35" rx="5" fill="#264653" stroke="#2a9d8f" stroke-width="1.5"/><text x="67" y="70" text-anchor="middle" fill="#e0e0e0" font-size="9">/tmp/healthy</text><text x="67" y="82" text-anchor="middle" fill="#2a9d8f" font-size="9">exists (exit 0)</text><line x1="110" y1="72" x2="130" y2="72" stroke="#888" stroke-width="1.5" marker-end="url(#a85)"/><rect x="130" y="55" width="85" height="35" rx="5" fill="#6b2c3b" stroke="#e76f51" stroke-width="1.5"/><text x="172" y="70" text-anchor="middle" fill="#e0e0e0" font-size="9">File deleted</text><text x="172" y="82" text-anchor="middle" fill="#e76f51" font-size="9">cat fails (exit 1)</text><line x1="215" y1="72" x2="235" y2="72" stroke="#888" stroke-width="1.5" marker-end="url(#a85)"/><rect x="235" y="55" width="70" height="35" rx="5" fill="#3d405b" stroke="#888" stroke-width="1.5"/><text x="270" y="70" text-anchor="middle" fill="#e0e0e0" font-size="9">Failures</text><text x="270" y="82" text-anchor="middle" fill="#e0e0e0" font-size="9">counted</text><line x1="305" y1="72" x2="320" y2="72" stroke="#888" stroke-width="1.5" marker-end="url(#a85)"/><rect x="320" y="55" width="60" height="35" rx="5" fill="#7b2d26" stroke="#e63946" stroke-width="1.5"/><text x="350" y="70" text-anchor="middle" fill="#e0e0e0" font-size="9">Kill &amp;</text><text x="350" y="82" text-anchor="middle" fill="#e0e0e0" font-size="9">Restart</text><text x="200" y="125" text-anchor="middle" fill="#aaa" font-size="10">failureThreshold consecutive failures triggers restart</text><text x="200" y="145" text-anchor="middle" fill="#aaa" font-size="10">App self-signals unhealthy by removing the marker file</text><defs><marker id="a85" viewBox="0 0 10 10" refX="9" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse"><path d="M 0 0 L 10 5 L 0 10 z" fill="#888"/></marker></defs></svg>',
    options: [
  ...
  },
  {
    ...
    diagram: '<svg viewBox="0 0 400 180" xmlns="http://www.w3.org/2000/svg"><rect x="10" y="10" width="380" height="160" rx="8" fill="#1a1a2e" stroke="#444" stroke-width="1.5"/><text x="200" y="35" text-anchor="middle" fill="#e0e0e0" font-size="13" font-weight="bold">Pod Termination Lifecycle</text><rect x="20" y="55" width="65" height="30" rx="5" fill="#264653" stroke="#2a9d8f" stroke-width="1.5"/><text x="52" y="74" text-anchor="middle" fill="#e0e0e0" font-size="9">SIGTERM</text><line x1="85" y1="70" x2="105" y2="70" stroke="#888" stroke-width="1.5" marker-end="url(#a88)"/><rect x="105" y="55" width="130" height="30" rx="5" fill="#3d405b" stroke="#888" stroke-width="1.5"/><text x="170" y="74" text-anchor="middle" fill="#e0e0e0" font-size="9">Grace period (30s)</text><line x1="235" y1="70" x2="260" y2="70" stroke="#888" stroke-width="1.5" marker-end="url(#a88)"/><rect x="260" y="55" width="65" height="30" rx="5" fill="#7b2d26" stroke="#e63946" stroke-width="1.5"/><text x="292" y="74" text-anchor="middle" fill="#e0e0e0" font-size="9">SIGKILL</text><text x="170" y="115" text-anchor="middle" fill="#aaa" font-size="10">App should handle SIGTERM: finish requests, close connections</text><text x="170" y="135" text-anchor="middle" fill="#aaa" font-size="10">If still running after 30s, kernel sends SIGKILL (unblockable)</text><defs><marker id="a88" viewBox="0 0 10 10" refX="9" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse"><path d="M 0 0 L 10 5 L 0 10 z" fill="#888"/></marker></defs></svg>',
    options: [
  ...
  },
  {
    ...
    options: [
      ...
      "The container received a SIGKILL (signal 9) from an external source such as the liveness probe or a manual `kill -9`",
      "The container's storage volume became read-only, forcing an immediate termination with signal 9 from the Linux kernel",
