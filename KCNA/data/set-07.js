...
var questions = [
  ...
  },
  {
    ...
    options: [
      ...
      "`spec.progressDeadlineSeconds` — defines the maximum time the Deployment controller waits for rollout progress before reporting the condition `ProgressDeadlineExceeded` as failed"
    ],
    answer: 3,
  ...
  },
  {
    ...
    options: [
      ...
      "The container received a SIGKILL (signal 9) from an external source such as a manual `kill -9` command or the kernel OOM killer acting on system-level memory pressure",
