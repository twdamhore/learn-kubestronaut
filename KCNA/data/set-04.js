...
var questions = [
  ...
  },
  {
    ...
    answer: 2,
    explanation: "Rook is a CNCF graduated project that provides storage orchestration for Kubernetes, with its primary use case being managing Ceph clusters. It turns distributed storage into self-managing, self-scaling, and self-healing services. Longhorn is also a CNCF graduated project but provides block storage and does not orchestrate Ceph clusters. MinIO is not a CNCF-hosted project. OpenEBS was a CNCF sandbox project (now archived), not graduated.\n\nWhy other options are wrong:\n- A: Longhorn is also a CNCF graduated project providing block storage but does not orchestrate Ceph clusters\n- B: MinIO is not a CNCF-hosted project; it is a standalone S3-compatible object storage server\n- D: OpenEBS was a CNCF sandbox project (now archived), not graduated\n\nReference: https://www.cncf.io/projects/rook/",
    verify: null
  },
  {
    id: "s04-q014",
