...
var questions = [
  ...
  },
  {
    ...
    diagram: '<svg viewBox="0 0 380 140" xmlns="http://www.w3.org/2000/svg"><rect x="150" y="10" width="100" height="50" rx="5" fill="#FFF3CD" stroke="#FFC107" stroke-width="2"/><text x="200" y="32" text-anchor="middle" font-size="11" fill="#333" font-weight="bold">PV (100Gi)</text><text x="200" y="48" text-anchor="middle" font-size="8" fill="#666">RWO + ROX</text><rect x="20" y="90" width="100" height="40" rx="5" fill="#D4EDDA" stroke="#28A745"/><text x="70" y="115" text-anchor="middle" font-size="10" fill="#333">PVC-1 (Bound)</text><rect x="260" y="90" width="100" height="40" rx="5" fill="#F8D7DA" stroke="#CC0000" stroke-dasharray="4"/><text x="310" y="115" text-anchor="middle" font-size="10" fill="#CC0000">PVC-2 (???)</text><line x1="170" y1="60" x2="70" y2="90" stroke="#28A745" stroke-width="2"/><line x1="230" y1="60" x2="310" y2="90" stroke="#CC0000" stroke-width="1.5" stroke-dasharray="5,3"/><text x="290" y="78" text-anchor="middle" font-size="18" fill="#CC0000">X</text><text x="200" y="80" text-anchor="middle" font-size="9" fill="#666">binding result?</text></svg>',
    options: [
