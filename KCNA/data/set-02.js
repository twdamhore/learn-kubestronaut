...
var questions = [
  ...
  },
  {
    ...
    diagram: '<svg viewBox="0 0 400 250" xmlns="http://www.w3.org/2000/svg"><rect x="10" y="10" width="380" height="230" rx="8" fill="#1a1a2e" stroke="#326CE5" stroke-width="2"/><text x="200" y="35" text-anchor="middle" fill="#326CE5" font-size="14" font-weight="bold">Canary Deployment with ConfigMaps</text><rect x="30" y="55" width="150" height="70" rx="5" fill="#2d6a4f" stroke="#4caf50" stroke-width="1"/><text x="105" y="80" text-anchor="middle" fill="white" font-size="12">Stable (v1)</text><text x="105" y="100" text-anchor="middle" fill="#ccc" font-size="10">config-v1</text><text x="105" y="115" text-anchor="middle" fill="#ccc" font-size="10">90% traffic</text><rect x="220" y="55" width="150" height="70" rx="5" fill="#e63946" stroke="#ff6b6b" stroke-width="1"/><text x="295" y="80" text-anchor="middle" fill="white" font-size="12">Canary (v2)</text><text x="295" y="100" text-anchor="middle" fill="#ccc" font-size="10">config-v2</text><text x="295" y="115" text-anchor="middle" fill="#ccc" font-size="10">10% traffic</text><rect x="80" y="155" width="240" height="40" rx="5" fill="#16213e" stroke="#326CE5" stroke-width="1"/><text x="200" y="180" text-anchor="middle" fill="#e0e0e0" font-size="11">Each version references its own ConfigMap</text><text x="200" y="220" text-anchor="middle" fill="#aaa" font-size="10">Separate Deployments + separate ConfigMaps</text></svg>',
    options: [
  ...
  // ── Kubernetes Fundamentals (11) ──────────────
  {
    ...
    diagram: '<svg viewBox="0 0 400 250" xmlns="http://www.w3.org/2000/svg"><rect x="10" y="10" width="380" height="230" rx="8" fill="#1a1a2e" stroke="#326CE5" stroke-width="2"/><text x="200" y="35" text-anchor="middle" fill="#326CE5" font-size="14" font-weight="bold">ConfigMap with items</text><rect x="130" y="50" width="140" height="40" rx="5" fill="#326CE5"/><text x="200" y="75" text-anchor="middle" fill="white" font-size="12">ConfigMap: app-config</text><line x1="160" y1="90" x2="90" y2="130" stroke="#555" stroke-width="1"/><line x1="240" y1="90" x2="310" y2="130" stroke="#555" stroke-width="1"/><rect x="30" y="130" width="130" height="50" rx="5" fill="#2d6a4f"/><text x="95" y="150" text-anchor="middle" fill="white" font-size="11">Container A</text><text x="95" y="168" text-anchor="middle" fill="#ccc" font-size="10">items: app-a.conf</text><rect x="240" y="130" width="130" height="50" rx="5" fill="#2d6a4f"/><text x="305" y="150" text-anchor="middle" fill="white" font-size="11">Container B</text><text x="305" y="168" text-anchor="middle" fill="#ccc" font-size="10">items: app-b.conf</text><text x="200" y="215" text-anchor="middle" fill="#aaa" font-size="10">Each volume uses items to select specific keys</text></svg>',
    options: [
  ...
  },
  {
    ...
    diagram: '<svg viewBox="0 0 400 200" xmlns="http://www.w3.org/2000/svg"><rect x="10" y="10" width="380" height="180" rx="8" fill="#1a1a2e" stroke="#326CE5" stroke-width="2"/><text x="200" y="35" text-anchor="middle" fill="#326CE5" font-size="14" font-weight="bold">Admission Control Sequence</text><rect x="20" y="55" width="100" height="45" rx="5" fill="#2d6a4f"/><text x="70" y="73" text-anchor="middle" fill="white" font-size="10">LimitRanger</text><text x="70" y="88" text-anchor="middle" fill="#ccc" font-size="9">Injects 128Mi</text><line x1="120" y1="77" x2="155" y2="77" stroke="#4caf50" stroke-width="2" marker-end="url(#a)"/><text x="137" y="70" text-anchor="middle" fill="#4caf50" font-size="10">1</text><rect x="155" y="55" width="100" height="45" rx="5" fill="#e6a817"/><text x="205" y="73" text-anchor="middle" fill="white" font-size="10">ResourceQuota</text><text x="205" y="88" text-anchor="middle" fill="#ccc" font-size="9">Checks total</text><line x1="255" y1="77" x2="290" y2="77" stroke="#e6a817" stroke-width="2"/><text x="272" y="70" text-anchor="middle" fill="#e6a817" font-size="10">2</text><rect x="290" y="55" width="80" height="45" rx="5" fill="#326CE5"/><text x="330" y="73" text-anchor="middle" fill="white" font-size="10">Persist</text><text x="330" y="88" text-anchor="middle" fill="#ccc" font-size="9">to etcd</text><text x="200" y="140" text-anchor="middle" fill="#e0e0e0" font-size="11">LimitRanger runs first (mutating),</text><text x="200" y="158" text-anchor="middle" fill="#e0e0e0" font-size="11">then ResourceQuota validates the total.</text></svg>',
    options: [
  ...
  // ── Cloud Native Observability (2) ─────────────
  {
    ...
    diagram: '<svg viewBox="0 0 400 200" xmlns="http://www.w3.org/2000/svg"><rect x="10" y="10" width="380" height="180" rx="8" fill="#1a1a2e" stroke="#326CE5" stroke-width="2"/><text x="200" y="35" text-anchor="middle" fill="#326CE5" font-size="14" font-weight="bold">Log Enrichment Pipeline</text><rect x="20" y="55" width="90" height="40" rx="5" fill="#2d6a4f"/><text x="65" y="80" text-anchor="middle" fill="white" font-size="11">Pod Logs</text><line x1="110" y1="75" x2="140" y2="75" stroke="#555" stroke-width="2"/><rect x="140" y="55" width="110" height="40" rx="5" fill="#e6a817"/><text x="195" y="75" text-anchor="middle" fill="white" font-size="11">Fluentd +</text><text x="195" y="88" text-anchor="middle" fill="white" font-size="9">K8s metadata plugin</text><line x1="250" y1="75" x2="280" y2="75" stroke="#555" stroke-width="2"/><rect x="280" y="55" width="100" height="40" rx="5" fill="#326CE5"/><text x="330" y="80" text-anchor="middle" fill="white" font-size="11">Enriched Logs</text><rect x="140" y="115" width="110" height="35" rx="5" fill="#16213e" stroke="#e6a817" stroke-width="1"/><text x="195" y="137" text-anchor="middle" fill="#e0e0e0" font-size="10">Kubernetes API</text><line x1="195" y1="95" x2="195" y2="115" stroke="#e6a817" stroke-width="1" stroke-dasharray="3,3"/></svg>',
    options: [
  ...
  },
  {
    ...
    diagram: '<svg viewBox="0 0 400 250" xmlns="http://www.w3.org/2000/svg"><rect x="10" y="10" width="380" height="230" rx="8" fill="#1a1a2e" stroke="#326CE5" stroke-width="2"/><text x="200" y="35" text-anchor="middle" fill="#326CE5" font-size="14" font-weight="bold">Helm Checksum Pattern</text><rect x="40" y="55" width="140" height="50" rx="5" fill="#326CE5"/><text x="110" y="75" text-anchor="middle" fill="white" font-size="12">ConfigMap</text><text x="110" y="92" text-anchor="middle" fill="#ccc" font-size="10">content changes</text><line x1="110" y1="105" x2="110" y2="125" stroke="#4caf50" stroke-width="2"/><text x="125" y="118" fill="#4caf50" font-size="9">sha256</text><rect x="40" y="125" width="140" height="50" rx="5" fill="#e6a817"/><text x="110" y="145" text-anchor="middle" fill="white" font-size="12">Annotation</text><text x="110" y="162" text-anchor="middle" fill="#ccc" font-size="10">checksum changes</text><line x1="180" y1="150" x2="220" y2="150" stroke="#e6a817" stroke-width="2"/><rect x="220" y="125" width="140" height="50" rx="5" fill="#2d6a4f"/><text x="290" y="145" text-anchor="middle" fill="white" font-size="12">Pod Template</text><text x="290" y="162" text-anchor="middle" fill="#ccc" font-size="10">spec changes → rollout</text><text x="200" y="210" text-anchor="middle" fill="#e0e0e0" font-size="11">ConfigMap change → new checksum →</text><text x="200" y="228" text-anchor="middle" fill="#e0e0e0" font-size="11">pod template change → rolling update</text></svg>',
    options: [
